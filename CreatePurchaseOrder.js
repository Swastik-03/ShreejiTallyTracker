     ...
     <IMPORTDATA>
      ...
      <REQUESTDATA>
       <TALLYMESSAGE xmlns:UDF="TallyUDF">
        <VOUCHER REMOTEID="${guid}" VCHKEY="${guid}-0000aff7:00000038" VCHTYPE="Purchase Order" ACTION="Create" OBJVIEW="Invoice Voucher View">
         <ADDRESS.LIST TYPE="String">
          <ADDRESS>${Address}</ADDRESS>
         </ADDRESS.LIST>
         <BASICBUYERADDRESS.LIST TYPE="String">
          <BASICBUYERADDRESS>${companydetails.address[0]}</BASICBUYERADDRESS>
          <BASICBUYERADDRESS>${companydetails.address[1]}</BASICBUYERADDRESS>
          <BASICBUYERADDRESS>E-Mail : ${companydetails.email}</BASICBUYERADDRESS>
         ...
         <CONSIGNEEGSTIN>23ABGCS3840J1ZB</CONSIGNEEGSTIN>
         <CONSIGNEEMAILINGNAME>${companydetails.Name}</CONSIGNEEMAILINGNAME>
         <CONSIGNEEPINCODE>${companydetails.pincode}</CONSIGNEEPINCODE>
         <CONSIGNEESTATENAME>${companydetails.state}</CONSIGNEESTATENAME>
         ...
         <EICHECKPOST>Self</EICHECKPOST>
         <BASICSHIPPEDBY>${Sby}</BASICSHIPPEDBY>
         <BASICBUYERNAME>${companydetails.Name}</BASICBUYERNAME>
         <BASICFINALDESTINATION>Kukshi</BASICFINALDESTINATION>
         ...
         <CONSIGNEEPINNUMBER>${companydetails.incometaxno}</CONSIGNEEPINNUMBER>
